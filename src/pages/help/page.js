...
const FAQS = [
  {
    ...
    answer:
      "Bạn có thể theo dõi đơn hàng bằng cách đăng nhập vào tài khoản Brand-Dress của mình, đi đến mục 'Đơn hàng của tôi', và nhấp vào 'Theo dõi' bên cạnh đơn hàng bạn muốn kiểm tra. Bạn cũng có thể nhận thông báo cập nhật về trạng thái đơn hàng qua email hoặc ứng dụng Brand-Dress.",
  ...
  },
  {
    ...
    answer:
      "Để trả lại một món hàng, hãy đăng nhập vào tài khoản Brand-Dress của bạn, đi đến 'Đơn hàng của tôi', tìm đơn hàng bạn muốn trả lại, và nhấp vào 'Trả lại hàng'. Làm theo hướng dẫn để hoàn tất quy trình trả hàng. Lưu ý rằng chính sách trả hàng có thể khác nhau tùy thuộc vào người bán.",
    category: "Trả lại hàng & hoàn tiền",
  },
  {
    id: 3,
    question: "Tôi quên mật khẩu Brand-Dress của mình. Làm thế nào để đặt lại?",
    answer:
      "Nếu bạn quên mật khẩu, hãy nhấp vào liên kết 'Đăng nhập' ở góc trên cùng của trang Brand-Dress, sau đó nhấp vào 'Quên mật khẩu của bạn?'. Nhập địa chỉ email hoặc tên người dùng của bạn và làm theo hướng dẫn để đặt lại mật khẩu. Bạn sẽ nhận được email với hướng dẫn để tạo mật khẩu mới.",
  ...
  },
  {
    ...
    answer:
      "Để thêm hoặc thay đổi phương thức thanh toán, hãy đăng nhập vào tài khoản Brand-Dress của bạn, đi đến 'Tài khoản', sau đó chọn 'Phương thức thanh toán'. Từ đây, bạn có thể thêm thẻ tín dụng mới, tài khoản PayPal, hoặc phương thức thanh toán khác, cũng như chỉnh sửa hoặc xóa các phương thức hiện có.",
    category: "Thanh toán & Hóa đơn",
  },
  {
    id: 6,
    question: "Làm thế nào để bắt đầu bán hàng trên Brand-Dress?",
    answer:
      "Để bắt đầu bán hàng trên Brand-Dress, hãy đăng nhập vào tài khoản của bạn và nhấp vào 'Bán' ở góc trên cùng của trang. Làm theo hướng dẫn để tạo danh sách sản phẩm của bạn. Bạn sẽ cần cung cấp thông tin về sản phẩm, hình ảnh, giá cả, và tùy chọn vận chuyển. Brand-Dress cũng cung cấp các công cụ và tài nguyên để giúp bạn tối ưu hóa danh sách và tăng doanh số bán hàng.",
  ...
  },
  {
    ...
    answer:
      "Để thay đổi địa chỉ giao hàng, hãy đăng nhập vào tài khoản Brand-Dress của bạn, đi đến 'Tài khoản', sau đó chọn 'Địa chỉ'. Từ đây, bạn có thể thêm địa chỉ mới, chỉnh sửa địa chỉ hiện có, hoặc đặt địa chỉ mặc định cho các giao dịch mua trong tương lai.",
...
const HELP_ARTICLES = [
  {
    id: 1,
    title: "Hướng dẫn đầy đủ về việc trả lại hàng trên Brand-Dress",
    category: "Trả lại hàng & hoàn tiền",
    views: 45678,
    helpful: 92,
    date: "2023-05-15",
  ...
  {
    id: 2,
    title: "Cách bảo vệ tài khoản Brand-Dress của bạn khỏi lừa đảo",
    category: "Tài khoản & Bảo mật",
    views: 34567,
    helpful: 95,
    date: "2023-06-22",
...
const HelpContact = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { sender: "bot", text: "Xin chào! Tôi là trợ lý ảo của Brand-Dress. Tôi có thể giúp gì cho bạn hôm nay?" },
  ])
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (messageInput.toLowerCase().includes("trả lại") || messageInput.toLowerCase().includes("hoàn tiền")) {
        botResponse =
          "Để trả lại hàng, vui lòng đăng nhập vào tài khoản Brand-Dress của bạn, đi đến 'Đơn hàng của tôi', tìm đơn hàng bạn muốn trả lại, và nhấp vào 'Trả lại hàng'. Bạn có cần hỗ trợ thêm không?"
      } else if (
      ...
      <main className="max-w-[1300px] mx-auto px-4 py-6">
        ...
        <div className="bg-gradient-to-r from-[#0053A0] to-[#00438A] rounded-lg p-6 mb-8 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl font-bold mb-4">Trung tâm trợ giúp Brand-Dress</h1>
          ...
          <div className="bg-gradient-to-r from-[#00A86B] to-[#00C853] rounded-lg p-6 text-white">
            <div className="flex flex-col md:flex-row items-center">
              <div className="mb-6 md:mb-0 md:mr-6 flex-shrink-0 text-center">
                ...
                <h3 className="text-xl font-bold">Cộng đồng Brand-Dress</h3>
              </div>

              <div className="flex-grow">
                <p className="mb-4">
                  Tham gia cộng đồng Brand-Dress để kết nối với những người mua và người bán khác, chia sẻ kinh nghiệm, và nhận
